    ...
    <>
      <div className='flex flex-row place-content-between'>
        <div className='flex flex-col ml-14 mt-32'>
          ...
          <button className='px-4 py-2 font-semibold text-sm bg-sky-500 text-white rounded-md shadow-sm mt-8' onClick={() => setShowModal(true)}>Watch a Tutorial</button>
          <h3 className='font-bold mt-44'>Whenever you're ready</h3>
          <button className='text-xl mt-4 px-4 py-2 font-semibold text-sm bg-sky-500 text-white rounded-md shadow-sm' onClick={() => setShowModal(true)}>Start a Meeting Now</button>
          <button className='text-xl mt-4 px-4 py-2 font-semibold text-sm bg-sky-500 text-white rounded-md shadow-sm' onClick={() => setShowModal(true)}>Schedule a Meeting Later</button>
        </div>
        <div className='flex flex-col text-right mr-14'>
          <h1 className='mt-8'>Profile</h1>
          <h1 className='font-bold text-left mt-80'>Planned Meetings</h1>
          <PlannedMeetings />
        </div>
...
function Modal({ showModal, setShowModal }) {
  ...
  return (
    <div class="z-20 ml-[40%] mt-32 absolute bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all">
      <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        ...
        <input className='sm:ml-4 border' type='text' placeholder='Email: '/>
      </div>
